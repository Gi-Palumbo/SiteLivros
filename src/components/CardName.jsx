export default function Cardfilme({filme}){
    return (
        <div className="flex flex-col gap-1 items-center w-40 m-2">
            ...
            <span className=" italic font-normal text-lg w-full line-clamp-1 text-center">{filme.autor}</span>
            ...
            <a href="#" className="bg-fuchsia-700 w-full rounded text-center py-1 hover:bg-fuchsia-900">Detalhes</a>
       </div>
    )
}